...
const ITEMS: EdgeItem[] = [
  ...
  },
  {
    ...
    Icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden>
        <path
          d="M12 2a5 5 0 015 5v3a5 5 0 01-5 5"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M12 22a5 5 0 01-5-5v-3a5 5 0 015-5"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  return (
    <section id="edge" className="py-8" style={{ backgroundColor: '#1E3A8A' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6" ref={headerRef as any}>
          <h2 className="h2-style text-2xl md:text-3xl text-white">
            Our Edge for MNCs & Enterprise Clients
          </h2>
          <p className="text-body-sm mt-2 text-white/80">
            Trusted operational excellence designed for scale, speed, and security.
          </p>
        </div>
