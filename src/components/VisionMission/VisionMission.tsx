    ...
    <section id="vision-mission" className="py-12 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          {/* Vision Block */}
          <div ref={visionRef as any} className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 shadow-sm opacity-0 translate-y-8 transition-all duration-600 ease-[cubic-bezier(0.22,0.9,0.3,1)]">
          ...
          {/* Mission Block */}
          <div ref={missionRef as any} className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 shadow-sm opacity-0 translate-y-8 transition-all duration-600 ease-[cubic-bezier(0.22,0.9,0.3,1)]">
            <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
